...
Standard template for ingeni-youtube-playlist
...
class iytpl_template {
    ...
    function iytpl_render_one_post( $video_id, $video_count, $title, $description, $thumbnail_url ) {
		...
		// Video container
		$this->html .=' <div class="ratio ratio-16x9 video-embed">';
			$this->html .= '<div class="embed-iframe" data-src="'.$video_id.'" id="yt_video_'.$video_count.'"></div>';
		$this->html .= '</div>';
